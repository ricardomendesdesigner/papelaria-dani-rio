...
export default function GraficaPage() {
  ...
  useEffect(() => {
    fetch("/api/products?category=grafica")
      .then((r) => r.json())
      .then((data) => {
        setProducts(data);
        setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50/50 to-white">
      <div className="bg-gradient-to-r from-teal-500 to-cyan-600 py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-white/80 text-lg">
            Cartões, banners, adesivos e materiais personalizados
          </p>
        </div>
      </div>
            ...
            {[...Array(8)].map((_, i) => (
              <div key={i} className="card animate-pulse">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="h-6 bg-teal-100 rounded w-1/2" />
                </div>
              </div>
            ))}
          </div>
